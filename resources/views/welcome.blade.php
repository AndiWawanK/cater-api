...
<body>
  ...
  <![endif]-->
    ...
    <header class="header-area">
        ...
        <div id="home" class="header-hero bg_cover d-lg-flex align-items-center" style="background-image: url({{ asset('frontend/assets/images/header-hero.jpg') }})">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
            ...
            <div class="header-hero-image d-flex align-items-center wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="1.1s">
                <div class="image">
                    <img src="{{ asset('frontend/assets/images/hero-image.png') }}" alt="Hero Image">
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="our-services-image mt-50">
                                            <img src="{{ asset('frontend/assets/images/our-service-1.jpg') }}" alt="service">
        ...
        <div class="container">
            ...
            <div class="row grid">
                <div class="col-lg-4 col-sm-6 grid-item apps creative laptop">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('frontend/assets/images/protfolio-1.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('frontend/assets/images/protfolio-1.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('frontend/assets/images/protfolio-2.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('frontend/assets/images/protfolio-2.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps branding product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('frontend/assets/images/protfolio-3.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('frontend/assets/images/protfolio-3.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('frontend/assets/images/protfolio-5.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('frontend/assets/images/protfolio-5.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('frontend/assets/images/protfolio-4.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('frontend/assets/images/protfolio-4.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('frontend/assets/images/protfolio-6.jpg') }}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('frontend/assets/images/protfolio-6.jpg') }}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.4s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="{{ asset('frontend/assets/images/news-1.jpg') }}" alt="news"></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="1s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="{{ asset('frontend/assets/images/news-3.jpg') }}" alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="blog-details.html">Nulla eget urna at tortor  turpi feugiat tristique in sit.</a></h4>
                            <div class="blog-author d-flex align-items-center">
    ...
    <footer id="footer" class="footer-area bg_cover" style="background-image: url({{ asset('frontend/assets/images/footer-bg.jpg') }})">
        <div class="container">
    ...
    <!--====== Circles js ======-->
    <script src="{{ asset('frontend/assets/js/circles.min.js') }}"></script>
