                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                ...
                                <img src="{{ asset('assets/assets/images/logo-text.png') }}" alt="homepage" class="dark-logo logo-cater" />
                                <img src="{{ asset('assets/assets/images/logo-text.png') }}" alt="homepage" class="light-logo logo-cater" />
                                <!-- Light Logo icon -->
